<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full focus:border-blue-600 focus:ring-blue-600" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full focus:border-blue-600 focus:ring-blue-600" type="text" name="phone" :value="old('phone')" required placeholder="Contoh: 08123456789" />
